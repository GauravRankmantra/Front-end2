...
const CreatePlaylist = () => {
  ...
  const { name, songs, availableSongs, loading, error, description } =
  ...
  const handleCreatePlaylist = () => {
    ...
    dispatch(createPlaylist({ name, songs, description, coverImage }));
    setCoverImage(null);
    setCoverPreview(null);
  };
  ...
  return (
    <div className="max-w-2xl mt-24 mx-auto p-6 bg-gray-800 text-white space-y-2 rounded-lg shadow-2xl">
      ...
      <button
        ...
        className="w-full mt-4 p-2 bg-green-500 rounded-md hover:bg-green-600 transition-all"
      >
        Create Playlist
      </button>
    </div>
